// The vendored module is plain ESM. Vite resolves the .wasm via `?url` and
// passes locateFile so emscripten finds the binary alongside the bundle.
//
...
import wasmUrl from '../../vendor/formulon/formulon.wasm?url';
